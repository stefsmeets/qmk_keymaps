...
// z x c d v  k m , . /
    [_BASE] = LAYOUT(
      ...
      SFT_TAB,    KC_N,    KC_R,    KC_S,    KC_T,    KC_G,                                        KC_Y,    KC_H,    KC_E,    KC_I,    KC_A, SFT_QUO,
      HPR_GUI,   CKC_Z,   CKC_X,    KC_C,    KC_D,    KC_V, KC_MPLY, COMPOSE, KC_PSCR, KC_MNXT,    KC_K,    KC_M, KC_COMM, CKC_DOT,CKC_SLSH, MEH_DEL,
...
// Layer: Symbol/number
    [_SYMBOL] = LAYOUT(
      _______, KC_TILD,   KC_AT, KC_LBRC, KC_RBRC, KC_PERC,                                      KC_DLR,    KC_7,    KC_8,    KC_9, KC_CIRC, _______,
      _______, KC_PLUS,  KC_EQL, KC_LPRN, KC_RPRN, KC_ASTR,                                     KC_HASH,    KC_4,    KC_5,    KC_6,  KC_DOT, _______,
      _______, KC_LABK, KC_PIPE, KC_MINS, KC_RABK,  KC_GRV,    LIST, _______, _______, _______, KC_AMPR,    NC_1,    KC_2,    KC_3, _______, _______,
...
// Adjust Layer: F-keys, Emoji, layouts
    [_FUNCTION] = LAYOUT(
      ...
      _______,   KC_F9,  KC_F10,  KC_F11,  KC_F12, XXXXXXX, _______, _______, _______, _______, UM(E31), UM(E32), UM(E33), UM(E34), UM(E35), UM(E36),
                                 _______, _______, _______, _______, _______, C(KC_P), _______, _______, KC_VOLD, KC_VOLU
    ),
